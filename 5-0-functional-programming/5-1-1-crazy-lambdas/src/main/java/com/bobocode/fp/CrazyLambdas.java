...
public class CrazyLambdas {
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        return (BigDecimal dec) -> "$".concat(String.valueOf(dec));
    }
    ...
    public static Predicate<String> lengthInRangePredicate(int min, int max) {
       return (String x) ->x.length() >=  min   &&  x.length() < max;
    }
    ...
    public static <T, U extends Comparable<? super U>> Comparator<T> thenComparing(
        ...
        return (a, b) -> {
            int comparisonResult = comparator.compare(a, b);
            return comparisonResult != 0 ? comparisonResult : mapper.apply(a).compareTo(mapper.apply(b));
        };
    }
    /**
